...
const APIMethods = {
    ...
    getPriceComparisonData: async (filters, showMedian = false, showPriceRange = false, showPriceDistribution = false, showPriceFluctuation = false, showOffersVolume = false) => {
        ...
        const response = await fetch(Constants.proxyBasePath + `/carhut-api/get-price-comparison-data?show-median=${showMedian}&show-price-range=${showPriceRange}&show-price-distribution=${showPriceDistribution}&show-price-fluctuation=${showPriceFluctuation}&show-offers-volume=${showOffersVolume}`, requestOptions);
        return response;
    },
